 ...
 * 例如 /auth/qq 就会匹配到此类 {@link QQConnectionFactory} 处理
 *
 * @see com.bfchengnuo.security.core.social.qq.config.QQAutoConfig  负责引入
 * @see org.springframework.social.security.provider.OAuth2AuthenticationService  负责调用执行
 *
 * @author 冰封承諾Andy
 * @date 2019-09-07
 */
